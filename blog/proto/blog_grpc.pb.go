...
type BlogServiceClient interface {
	...
	UpdateBlog(ctx context.Context, in *BlogId, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *blogServiceClient) UpdateBlog(ctx context.Context, in *BlogId, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type BlogServiceServer interface {
	...
	UpdateBlog(context.Context, *BlogId) (*empty.Empty, error)
...
func (UnimplementedBlogServiceServer) UpdateBlog(context.Context, *BlogId) (*empty.Empty, error) {
